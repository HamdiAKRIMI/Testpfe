...
echo hamdi | sudo -S su - test_user -c "ssh-keygen -t rsa -f /home/hamdi/.ssh/id_rsa -q -P ''"
#ssh-keygen -f ~/keypair -P ""
#ssh-keygen -t rsa -f /home/hamdi.pfe/.ssh/id_rsa -q -P ''

#:'
#echo hamdi.pfe | sudo -S su - hamdi.pfe -c "ssh-keygen -t rsa -b 2048 -f ~/.ssh/MyKeyPair.pem -q -P ''"
#sudo chmod 400 ~/.ssh/MyKeyPair.pem
#echo hamdi.pfe | sudo -S su - hamdi.pfe -c "ssh-keygen -y -f ~/.ssh/MyKeyPair.pem | tee -a ~/.ssh/MyKeyPair.pub"
#
#'
